...
class SimpleAPI:
    @validate_arguments
    def __init__(self, key, locale:str='en', scheme:str='https', domain:str='ctabustracker.com'):
        self._params = {
            'key': key,
            'format': 'json',
            'locale': locale
    ...
    @validate_arguments
    def getvehicles(self, vid: str | list | None = None, rt: str | list | None = None, tmres: str ='s') -> dict:
        ...
        print(self._format_url(ApiRoutes.VEHICLES, params))
        return r.json()
    ...
    @validate_arguments
    def getstops(self, rt: str | None = None, dir: str | None = None, stpid: str | list | None = None) -> dict:
        params = copy.deepcopy(self._params)
    ...
    @validate_arguments
    def getpatterns(self, pid: str | list | None = None, rt: str | list | None = None) -> dict:
        params = copy.deepcopy(self._params)
    ...
    @validate_arguments
    def getpredictions(self, stpid: str | list | None = None, rt: str | list | None = None, vid: str | list | None = None, top: int | None = None, tmres: str = 's') -> dict:
        params = copy.deepcopy(self._params)
    ...
    @validate_arguments
    def getservicebulletins(self, rt: str | list | None = None, rtdir: str | None = None, stpid: str | list | None = None) -> dict:
        params = copy.deepcopy(self._params)
