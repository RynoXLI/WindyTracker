...
from .bustracker import BusTracker, ApiArgumentError
from .models import (
    TimeResponse, RoutesResponse, DirectionsResponse, VehiclesResponse,
    StopsResponse, PredictionsResponse, PatternsResponse, ServiceBulletinsResponse,
    RtpiDataFeedsResponse, DetoursResponse, AgenciesResponse, LocalesResponse, ErrorResponse
)
...
class TypedBusTracker(BusTracker):
    ...
    def getlocalelist(self, inlocalLanguge: bool = False) -> Union[LocalesResponse, ErrorResponse]:
